var app = angular.module("admin-issue", []); 
...
app.controller("admin-issueCtrl", function($scope,$http) {
    ...
    var category_elem = document.getElementById("status");
    var status = category_elem.options[category_elem.selectedIndex].value;
    var url = app_url +"/putComplaint?status="+status+"&priority="+$scope.priority+"&complaintId="+complaintId;
    sendAjaxRequest(url,updateCallback);
    }
